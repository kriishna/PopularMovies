...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        assertEquals("Error: the MovieEntry CONTENT_URI should return MovieEntry.CONTENT_TYPE",
                MoviePopular.CONTENT_POPULAR_TYPE, type);
...
//    }
    ...
    static ContentValues[] createBulkInsertMovieValues() {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++ ) {
            ...
            movieValues.put(MoviePopular.COLUMN_MOVIE_ID, i);
            movieValues.put(MoviePopular.COLUMN_POPULAR_INDEX, i);
            movieValues.put(MoviePopular.COLUMN_TOP_RATED_INDEX, i);
    ...
    public void testBulkInsert() {
        ...
        Cursor cursor = mContext.getContentResolver().query(
                ...
                null, // cols for "where" clause
                null, // values for "where" clause
                MoviePopular.COLUMN_POPULAR_INDEX + " ASC"  // sort order == by POPULAR index ASCENDING
        );
